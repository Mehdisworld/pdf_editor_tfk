...
public class AdsUtility {
    ...
    public static void loadBannerAd(Activity activity,
        ...
        Log.d("BannerAdmob", MyApp.BannerAdmob);
    ...
    public static void loadInterstitialAd(Context context, String interstitial) {
    ...
    public static void loadNativeAd(Activity activity, FrameLayout nativeAdPlaceHolder) {
        ...
        AdLoader.Builder builder = new AdLoader.Builder(activity, MyApp.NativeAdmob);
