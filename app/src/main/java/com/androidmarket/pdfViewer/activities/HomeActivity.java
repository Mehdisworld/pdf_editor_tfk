...
import static com.androidmarket.pdfViewer.util.AdsUtility.mInterstitialAd;
...
import com.androidmarket.pdfViewer.util.MyApp;
...
public class HomeActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RelativeLayout infoWindowPopup = (RelativeLayout) findViewById(R.id.container_ban);

        AdsUtility.loadBannerAd(this, infoWindowPopup);
                ...
                if (mInterstitialAd.isLoaded()) {
                    ...
                    mInterstitialAd.setAdListener(new AdListener() {
                        ...
                        public void onAdClosed() {
                            AdsUtility.loadInterstitialAd(HomeActivity.this, MyApp.InterstitialAdmob);
